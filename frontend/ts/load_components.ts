declare function initHeader(): void;
declare function setActiveCategoryByUrl(): void;
declare function openLoginPopup(): void;
declare function openRegisterPopup(): void;
...
async function loadSingleComponent(element: HTMLElement): Promise<void> {
...
function initFooterLinks(): void {
    // Открываем поп-ап 
    const openAuthPopup = (popupId: string): void => {
...
function initComponentScripts(): void {
