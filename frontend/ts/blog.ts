...
import { createBlogCard, BlogPost } from './blog-card.js';
...
const blogGrid = document.getElementById('blog__grid')  as HTMLElement;
// Счетчик "Найдено N публикаций"
const blogCount = document.getElementById('blog__count') as HTMLElement;
// Все кнопки фильтра ("Все", "Статьи", "Новости", "Уроки")
const filterBtns = document.querySelectorAll<HTMLButtonElement>('.blog-filter__category');
...
let activeType: string = urlParams.get('type') ?? 'all';
