...
const imageContainer = document.getElementById('idea-page__image-container') as HTMLElement;
const imageEl = document.getElementById('idea-page__image') as HTMLImageElement;
const contentEl = document.getElementById('idea-page__content')!;
const attrsEl = document.getElementById('idea-page__attrs') as HTMLElement | null;
const productsEl = document.getElementById('idea-page__products') as HTMLElement | null;
...
const init = async (): Promise<void> => {
    ...
    try {
        ...
        if (productsEl && t.products?.length) {
            ...
            t.products.forEach((p: Record<string, unknown>) => {
                productsEl.appendChild(createProductCard(p as any));
            });
        }
